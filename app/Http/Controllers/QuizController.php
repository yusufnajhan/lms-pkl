...
class QuizController extends Controller
{
    ...
    public function results(Request $request)
    {
        ...
        $comment=match(true){
            $percentage>=80 && $percentage<=100 => 'Congratulations, You Aced It!!',
            $percentage>=60 && $percentage<=79 => 'Awesome!!',
            $percentage>=40 && $percentage<=59 => 'You did a pretty good job.',
            $percentage<40 => 'Do not be sad, keep trying.',
