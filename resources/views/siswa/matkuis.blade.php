...
<div class="mb-4">
    ...
    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Nama Kuis</h1>
</div>
...
<form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
    <article class="mb-5">
      ...
      <p class="mt-5 mb-2 text-gray-900 dark:text-white">
        Deskripsi kuis bla bla bla bla
      </p>
    ...
    <div class="w-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
            <label for="comment" class="sr-only">Menulis jawaban kuis</label>
            <textarea id="comment" rows="8" class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Menulis jawaban kuis" required></textarea>
        </div>
