...
<div class="mb-4">
    ...
    <footer class="mt-5 flex items-center justify-between mb-2">
      <div class="flex items-center">
        <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate datetime="2022-02-08" title="February 8th, 2022">Diunggah pada: {{ $kuis->tanggal_mulai }}</time></p>
      </div>
  </footer>
  <p class="text-sm font-bold text-gray-600 dark:text-gray-400"><time pubdate datetime="2022-02-08" title="February 8th, 2022">Tenggat waktu: {{ $kuis->tanggal_selesai }}</time></p>
</div>
