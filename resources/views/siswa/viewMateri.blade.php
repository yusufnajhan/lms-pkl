...
<div class="mb-4">
  ...
  <nav class="flex mb-5" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
      ...
      <li>
        <a href="{{ route('siswamasuk.index', $kelas->idkelas) }}">
...
<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    <ul class="hidden text-sm font-medium text-center text-red-500 divide-x divide-red-200 rounded-lg sm:flex dark:divide-red-600 dark:text-red-400" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
      <li class="w-full">
          <button type="button" href="#" class="inline-block w-full p-4 rounded-tr-lg hover:bg-transparent focus:outline-none dark:bg-transparent dark:hover:bg-transparent text-gray-500">Materi</button>
      </li>
    </ul> 
          ...
          <li class="py-3 sm:py-4">
            <div class="flex items-center space-x-4">
              <div class="flex-shrink-0">
                <a href="{{ route('materi.read2', $materi->idmateri) }}">
              ...
              <div class="flex-1 min-w-0">
                  <p class="font-medium text-gray-900 truncate dark:text-white">
                    <a href="{{ route('materi.read2', $materi->idmateri) }}" class="hover-red-underline">{{ $materi->judul_materi }}</a>
                  </p>
                  <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                    <a href="{{ route('materi.read2', $materi->idmateri) }}" class="hover-red-underline">{{ $materi->tanggal_upload }}</a>
                  </p>
              </div>                         
            </div>
          </li>
