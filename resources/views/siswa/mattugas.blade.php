...
<div class="mb-4">
        ...
        <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
          ...
          <li>
            <div class="flex items-center">
              ...
              <a href="/kelasMatematika" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Kelas Matematika 7A</a>
            </div>
          </li>
          <li>
            <div class="flex items-center">
    ...
    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Nama Tugas</h1>
</div>
...
<form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
    <article class="mb-5">
      <footer class="flex items-center justify-between mb-2">
            <div class="flex items-center">
              <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate datetime="2022-02-08" title="February 8th, 2022">Diunggah pada: 01/03/2023</time></p>
            </div>
      </footer>
      <p class="text-sm font-bold text-gray-600 dark:text-gray-400"><time pubdate datetime="2022-02-08" title="February 8th, 2022">Tenggat waktu: 01/03/2023 12:30 WIB</time></p>
      <p class="mt-5 mb-2 text-gray-900 dark:text-white">
        Deskripsi tugas bla bla bla bla
      </p>
      <div class="items-center 2xl:space-x-4 2xl:flex">
        ...
        <div class="flex items-center p-3 mb-3.5 border border-gray-200 dark:border-gray-700 rounded-lg">
          ...
          <div class="mr-4">
              <p class="text-sm font-semibold text-gray-900 dark:text-white">file tugas aljabar</p>
    ...
    <div class="w-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
            <label for="comment" class="sr-only">Menulis jawaban tugas</label>
            <textarea id="comment" rows="8" class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Menulis jawaban tugas" required></textarea>
        </div>
