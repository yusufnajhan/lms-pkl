        ...
        <div class="mt-4 grid gap-8 lg:grid-cols-2">
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a>{{ $kelas->mata_pelajaran }}</a></h2>
                        <h2 class="mb-2 text-xl tracking-tight text-gray-900 dark:text-white"><a>Kelas {{ $kelas->jenjang_kelas }}{{ $kelas->indeks_kelas }}</a></h2>
                    </div>
                </div>  
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                ...
                <div class="mt-4 flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        <img src="{{ URL('images/siswas.png') }}" alt="siswas" class="w-6 h-6 rounded-full">
                        <span class="font-medium dark:text-white">
                            {{ $kelas->jumlahSiswa }} siswa
                        </span>
                    </div>
                    @if(!$kelas->isExpired)
                    <a href="{{ route('tugaskuis.index', $kelas->idkelas) }}" class="inline-flex items-center font-medium text-red-600 dark:text-red-500 hover:underline">
                        Masuk kelas
