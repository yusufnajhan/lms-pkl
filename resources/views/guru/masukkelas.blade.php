...
<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
    ...
    <ul class="hidden text-sm font-medium text-center text-red-500 divide-x divide-red-200 rounded-lg sm:flex dark:divide-red-600 dark:text-red-400" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
      ...
      <li class="w-full">
          <a href="{{ route('materi.index') }}" class="inline-block w-full p-4 rounded-tr-lg bg-red-50 hover:bg-red-100 focus:outline-none dark:bg-red-700 dark:hover:bg-red-600 text-gray-500">Materi</a>
      </li>
      <li class="w-full">
                  ...
                  <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="font-medium text-gray-900 truncate dark:text-white">
                          <a href="/nilaiTugas">{{ $tugas->judul_tugas }}</a>
                        </p>
                        <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                          <a href="/nilaiTugas">{{ $tugas->tanggal_selesai }}</a>
                        </p>
                    </div>                  
          ...
          {{-- <a href="progresMat"> --}}
            <li class="py-3 sm:py-4">
              <div class="flex items-center space-x-4">
                ...
                {{-- <td class="p-4 space-x-2 whitespace-nowrap">
                    <button type="button" data-modal-toggle="delete-enroll-modal-{{ $enrollment->idenroll }}" class="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                        <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                        Hapus
                    </button>
                </td>  --}}
  ...
  <div class="relative w-full h-full max-w-md px-4 md:h-auto">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
          ...
          <div class="p-6 pt-0 text-center">
              ...
              <form method="POST" action="{{ route('tugas.destroy', $tugas->idtugas) }}"  
