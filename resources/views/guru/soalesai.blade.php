        ...
        <div class="flex items-center space-x-4">
          ...
          <td class="p-4 space-x-2 whitespace-nowrap">
            <a href="{{ route('esai.edit', $esai->idesai) }}">
              ...
              <button type="button" data-modal-toggle="delete-esai-modal-{{ $tugas->idtugas }}" class="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
