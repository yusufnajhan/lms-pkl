        ...
        <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
          ...
          <li>
            <div class="flex items-center">
              ...
              <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Kelas PKN</span>
            </div>
          </li>
        </ol>
    </nav>
    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Kelas PKN</h1>
    <h1 class="text-base text-gray-900 sm:text-lg dark:text-white">Kelas 7</h1>
</div>
            ...
            <div class="flex items-center space-x-4">
              ...
              <td class="p-4 space-x-2 whitespace-nowrap">
                <a href="#">
                  ...
                  <button type="button" data-modal-toggle="delete-tugas-modal-{{ $materi->idmateri }}" class="inline-flex items-center px-2 py-1 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
