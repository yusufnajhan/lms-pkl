        ...
        <div class="grid grid-cols-6 gap-6">
            ...
            @for ($i = 1; $i <= $jumlah_soal; $i++)
                <div class="col-span-6 sm:col-span-3">
                    <label for="soal[{{ $i }}][pertanyaan]"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pertanyaan No.{{ $i }}</label>
                    <textarea name="soal[{{ $i }}][pertanyaan]" id="soal[{{ $i }}][pertanyaan]"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        value="" wfd-id="id2"></textarea>

                    @error('soal[{{ $i }}][pertanyaan]')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>

                <div class="col-span-6 sm:col-span-3">
                    <label for="soal[{{ $i }}][pilihan][A]"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">A.</label>
                    <input type="text" name="soal[{{ $i }}][pilihan][A]" id="soal[{{ $i }}][pilihan][A]"
                    ...
                    @error('soal[{{ $i }}][pilihan][A]')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror

                    <label for="soal[{{ $i }}][pilihan][B]"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">B.</label>
                    <input type="text" name="soal[{{ $i }}][pilihan][B]" id="soal[{{ $i }}][pilihan][B]"
                        class="mb-4 shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        value="" wfd-id="id2" >


                    @error('soal[{{ $i }}][pilihan][B]')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror

                    <label for="soal[{{ $i }}][pilihan][C]"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">C.</label>
                    <input type="text" name="soal[{{ $i }}][pilihan][C]" id="soal[{{ $i }}][pilihan][C]"
                        class="mb-4 shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        value="" wfd-id="id2" >


                    @error('soal[{{ $i }}][pilihan][C]')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror

                    <label for="soal[{{ $i }}][pilihan][D]"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">D.</label>
                    <input type="text" name="soal[{{ $i }}][pilihan][D]" id="soal[{{ $i }}][pilihan][D]"
                        class="mb-4 shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        value="" wfd-id="id2" >

                    @error('soal[{{ $i }}][pilihan][D]')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror

                    <label for="soal[{{ $i }}][jawaban_benar]"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jawaban Benar</label>
                        <select name="soal[1][jawaban_benar]" id="soal[{{ $i }}][jawaban_benar]" class="mb-5 shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
