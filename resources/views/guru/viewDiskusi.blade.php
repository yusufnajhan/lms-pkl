  ...
  <nav class="flex mb-5" aria-label="Breadcrumb">
    ...
    <li>
      <div class="flex items-center">
        ...
        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Diskusi Kelas</span>
      </div>
    </li>
    </ol>
</nav>
          ...
          <li class="py-3 sm:py-4">
            <div class="flex items-center space-x-4">
              <div class="flex-shrink-0">
                <a href="{{ route('diskusi.read', $diskusi->iddiskusi) }}">
                    <img src="{{ URL('images/diskusi.png') }}" alt="diskusi" class="w-6 h-6">
                </a>
              </div>
              <style>
              ...
              <div class="flex-1 min-w-0">
                  <p class="font-medium text-gray-900 truncate dark:text-white">
                    <a href="{{ route('diskusi.read', $diskusi->iddiskusi) }}" class="hover-red-underline">{{ $diskusi->judul_diskusi }}</a>
                  </p>
                  <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                    <a href="{{ route('diskusi.read', $diskusi->iddiskusi) }}" class="hover-red-underline">{{ $diskusi->tanggal_upload }}</a>
                  </p>
              </div>                  
  ...
  <div class="relative w-full h-full max-w-md px-4 md:h-auto">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
          ...
          <div class="flex justify-end p-2">
              <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white" data-modal-toggle="delete-diskusi-modal-{{ $diskusi->iddiskusi }}">
