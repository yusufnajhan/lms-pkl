...
<nav class="flex mb-5" aria-label="Breadcrumb">
    ...
    <li>
      <div class="flex items-center">
        ...
        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Tambah Diskusi</span>
      </div>
    </li>
    </ol>
</nav>
    ...
    <form action="{{ route('diskusi.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-6 gap-6">
            {{-- <div class="col-span-6 sm:col-span-3">
                <label for="iddiskusi"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Diskusi</label>
                <input type="number" name="iddiskusi" id="iddiskusi"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    value="{{ old('iddiskusi') }}" wfd-id="id1" >
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <input type="text" name="judul_diskusi" id="judul_diskusi"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    value="{{ old('judul_diskusi') }}" wfd-id="id2" >
            ...
            {{-- <div class="col-span-6 sm:col-span-3">
                ...
                <input type="text" name="deskripsi_diskusi" id="deskripsi_diskusi"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    value="{{ old('deskripsi_diskusi') }}" wfd-id="id2" >
            ...
            <div class="col-span-6 sm:col-span-3"> 
                ...
                <textarea id="deskripsi_diskusi" name="deskripsi_diskusi" rows="6"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    >{{ old('deskripsi_diskusi') }}</textarea>
            ...
            <div class="col-span-6 sm:col-span-3">
                <label for="tanggal_upload" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal Mulai</label>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    const tanggalDiskusiInput = document.getElementById('tanggal_upload');
                    if (!tanggalDiskusiInput.value) {
                        const today = new Date().toISOString().split('T')[0];
                        tanggalDiskusiInput.value = today;
                    }
                });
            </script>
