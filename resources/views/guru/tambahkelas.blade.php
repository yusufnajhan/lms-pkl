        ...
        <div class="grid grid-cols-6 gap-6">
            ...
            <div class="col-span-6 sm:col-span-3">
                ...
                <select name="indeks_kelas" id="indeks_kelas"
                    ...
                    <option value="A"{{ old('indeks_kelas') == 'A' ? 'selected' : '' }}>A</option>
                    <option value="B"{{ old('indeks_kelas') == 'B' ? 'selected' : '' }}>B</option>
                    <option value="C"{{ old('indeks_kelas') == 'C' ? 'selected' : '' }}>C</option>
                    <option value="D"{{ old('indeks_kelas') == 'D' ? 'selected' : '' }}>D</option>
                    <option value="E"{{ old('indeks_kelas') == 'E' ? 'selected' : '' }}>E</option>
                </select>
            ...
            {{-- <div class="col-span-6 sm:col-span-3">
                ...
                <select name="idguru" id="idguru" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    ...
                    <option value="{{ auth()->user()->dataPribadi->idguru }}">{{ auth()->user()->dataPribadi->idguru }}</option>
                </select>
