    ...
    <form action="{{ route('kuis.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-6 gap-6">
            ...
            <div class="col-span-6 sm:col-full">
                <a href="/tambahKuis/soalEsai" class="inline-flex items-center p-2 text-xs font-medium uppercase rounded-lg text-red-700 sm:text-sm hover:bg-gray-100 dark:text-red-500 dark:hover:bg-gray-700">
                    esai
