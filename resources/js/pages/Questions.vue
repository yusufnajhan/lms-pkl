    ...
    <Layout>
        ...
        <Teleport to="body">
            <NewQuestionModal :show="showNewQuestionModal" @close="destroyModal">
                ...
                <template #footer>
                    <button @click="addNewAnswer" v-if="newAnswers.length < 4" class="btn btn-primary">
                        <h3>+</h3>
                    </button>
                    <button @click="destroyModal" class="btn btn-danger">
                        Close
                    </button>
                    <button v-if="newAnswers.length>3" @click="submitQuestion" class="btn btn-success">
                        Submit
                    </button>
